...
const SingleSofa = () => {
  ...
  return (
    <div>
    <div className='w-[1440px] h-[100px] flex items-center text-center gap-4'>
        <div>Home</div>
        <div ><MdKeyboardArrowRight size={20}/></div>
        <div>Shop</div>
        <div><MdKeyboardArrowRight size={20}/></div>
        <div className='w-[142px] h-[37px] text-4 border-l-[2px] border-[#9F9F9F] mt-3'>Asgaard Sofa</div>
    </div>
    <div className='w[1440px] h-[820px] flex justify-center items-center'>
      <div className='w-[1261px] h-[735.87px] flex justify-center'>
        {/*left side*/}
        <div className='w-[574px] h-[505px] flex justify-around'>
      ...
      {/*right side*/}
      <div className='w-[606px] h-[730px] mr-40'>
        <h1 className='w-[282px] h-[63px] text-4xl'>Asgaard Sofa</h1>
        <h2 className='w-[173px] h-[36px] text-xl text-[#9F9F9F]'>Rs. 250,000.00</h2>
        <div className='flex'>
        ...
        <p className='h-[21px] w-[27px] text-sm text-[#9F9F9F] mt-3'>Size</p>
          <ul className='flex space-x-3 mt-2'>
            ...
            <div className='flex mt-8'>
              <div className='flex w-[123px] h-[64px] space-x-6 border-[#9F9F9F] border-2 rounded-lg items-center p-5 text-base'>
                <button onClick={handledecrement}>-</button>
                <div>{counter}</div>
                <button onClick={handleIncrement}>+</button>
              </div>
              <div className='w-[215px] h-[64px] border-[#9F9F9F] border-2 rounded-lg items-center p-4 text-base ml-4 hover:bg-[#9F9F9F] hover:text-white'><button className='w-[119px] h-[30px] text-center ml-6 text-xl'>Add To Cart</button></div>
            </div>
    ...
    <div className='w-[1440px] h-[744px]'>
      <div className='w-[649px] h-[36px] flex justify-between items-center ml-96'>
        <div className='w-[136px] h-[36] text-2xl'>Description</div>
        
        <div className='w-[269px] h-[36px] text-2xl text-[#9F9F9F]'>Additional Information</div>
        <div className='w-[138px] h-[36px] text-2xl text-[#9F9F9F]'>Reviews [5]</div>
      </div>
      <div className='w-[1026px] h-[174px] ml-56 mt-10'>
      <p className='w-[1026px] h-[48] text-base'>Embodying the raw, wayward spirit of rock ‘n’ roll, the Kilburn portable active stereo speaker takes the unmistakable look and sound of Marshall, unplugs the chords, and takes the show on the road.</p>
      <p className='w-[1026px] h-[96px] text-base mt-6'>Weighing in under 7 pounds, the Kilburn is a lightweight piece of vintage styled engineering. Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound that is both articulate and pronounced. The analogue knobs allow you to fine tune the controls to your personal preferences while the guitar-influenced leather strap enables easy and stylish travel.</p>
      </div>
      <div className='w-[1239px] h-[348px] flex space-x-10 ml-36 mt-10'>
