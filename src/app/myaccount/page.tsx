...
const Myaccount = () => {
  return (
    <div>
    <div className='w-[1440px] h-[316px] flex flex-col md:flex-row justify-center items-center ml-10'>
        <Image src="/Group78(2).png" alt="image" width={1440} height={316} />
    </div>
    <div className='w-[1440px] h-[760px] flex flex-col md:flex-row justify-around items-center'>
        {/*left*/}
        <div className='w-[608px] h-[630px]'>
            <h1 className='font-semibold text-4xl'>Log In</h1>
            <div className='w-[424px] h-[121px] text-left text-base mt-4'>
              ...
              <div className='flex justify-items-start mt-10'>
                <div className='w-[30px] h-[27px] border-2 rounded-lg border-[#9F9F9F]'></div>
                <div className='text-base text-[#9F9F9F] ml-4'>Remember me</div>
              </div>
              <div className='flex justify-items-start mt-6'>
                <div><button className='w-[215px] h-[64px] border-2 border-[#9F9F9F] rounded-lg'>Log In</button></div>
        ...
        <div className='w-[608px] h-[630px]'>
            ...
            <div className='w-[424px] h-[121px] text-left text-base mt-4'>
              ...
              <div className='w-[430px] h-[143px] text-base text-left mt-4 pt-2'>
              ...
              <div><button className='w-[215px] h-[64px] border-2 border-[#9F9F9F] rounded-lg mt-16'>Register</button></div>
        </div>
    </div>
